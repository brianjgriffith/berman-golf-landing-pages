...
const posterFaqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "No. This is live-only by design. Showing up live is what separates the people who actually gain yards from the people who download a webinar replay and never watch it. The work happens with you in the room.",
  },
  {
