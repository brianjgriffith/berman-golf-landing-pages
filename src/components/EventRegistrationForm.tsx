...
const PHASE_COPY: Record<EventPhase, PhaseCopy> = {
  ...
  replay: {
    ...
    subhead:
      "Both sessions are yours to watch free through Wednesday, September 2 at midnight ET. Register below for instant access.",
            ...
            <div className="mt-8 border-t border-[#1a365d]/15 pt-6">
              <div className="flex flex-col gap-3 text-sm text-[#1a365d]/70">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Replay through Wed, Sept 2 (live is best).</span>
                </div>
              </div>
            </div>
          </aside>
