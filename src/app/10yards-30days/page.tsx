...
export default function TenYardsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "The program starts Wednesday, April 1st at 3:30 PM ET. After you enroll, you'll receive an email with your Zoom link and all the details to get started.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg">
            ...
            <p className="text-gray-700 mb-8 text-center">
              Starting April 1st, you&apos;ll join Dr. Jake Berman for 4 live group coaching sessions where he&apos;ll guide you through the exact system that&apos;s helped 1,000+ senior golfers gain 20-50 yards.
            </p>
            ...
            <div className="border-b border-gray-200 pb-8 mb-8">
              ...
              <ul className="space-y-3 text-gray-700">
                <li className="flex items-start gap-3">
                  <span className="text-[#F26B4E] font-bold">Week 1 (Wed 4/1):</span> Foundation & Muscle Activation
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#F26B4E] font-bold">Week 2 (Wed 4/8):</span> Top of Backswing Mastery
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#F26B4E] font-bold">Week 3 (Wed 4/15):</span> Downswing & Impact
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#F26B4E] font-bold">Week 4 (Wed 4/22):</span> Release & Finish
                </li>
              </ul>
            </div>
