...
export default function TenYardsPage() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "After you enroll, you'll receive an email with your Zoom link, the exact start date, and all the details to get started.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-white rounded-2xl p-8 md:p-12 shadow-lg">
            ...
            <p className="text-gray-700 mb-8 text-center">
              You&apos;ll join Dr. Jake Berman for 4 live group coaching sessions where he&apos;ll guide you through the exact system that&apos;s helped 1,000+ senior golfers gain 20-50 yards.
            </p>
