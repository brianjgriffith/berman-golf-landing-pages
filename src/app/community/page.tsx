        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Priority Support Access</h3>
              <p className="text-gray-600">
                Clubhouse members jump to the front of the line. Your questions get answered first — you&apos;re always top priority with Jake&apos;s team.
              </p>
            </div>
          </div>

          {/* 30-Day Challenges */}
          <div className="mt-8 bg-gradient-to-r from-[#F26B4E]/10 to-[#1565c0]/10 rounded-2xl p-8 text-center max-w-2xl mx-auto">
            <div className="w-16 h-16 bg-[#F26B4E] rounded-full flex items-center justify-center mx-auto mb-6">
              <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <h3 className="text-xl font-bold text-gray-900 mb-4">Access to All 30-Day Challenges</h3>
            <p className="text-gray-600">
              Throughout the year, Dr. Jake runs exclusive 30-day challenges to help you build new habits and see real results. As a Clubhouse member, you get free access to join any challenge — included with your membership.
            </p>
          </div>
        </div>
      </section>
