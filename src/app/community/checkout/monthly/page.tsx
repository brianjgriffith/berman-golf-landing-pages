...
export default function ClubhouseMonthlyCheckout() {
  useEffect(() => {
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm mb-6">
              ...
              <div className="text-center mb-6">
                <p className="text-sm text-gray-500 uppercase tracking-wide font-semibold mb-1">Monthly Membership</p>
                <p className="text-4xl font-bold text-gray-900">$47<span className="text-xl text-gray-500 font-normal">/month</span></p>
              </div>
            ...
            {/* Annual Option Callout */}
            <div className="bg-[#F26B4E]/10 border border-[#F26B4E]/30 rounded-2xl p-5 mb-6">
              <p className="text-gray-900 font-semibold mb-2">Want to save $267/year?</p>
              <p className="text-gray-600 text-sm mb-3">
                Get the annual membership for just $297/year (that&apos;s only $24.75/month!)
              </p>
              <Link
                href="/community/checkout/annual"
                className="text-[#F26B4E] font-semibold text-sm hover:underline"
              >
